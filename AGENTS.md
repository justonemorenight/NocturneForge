...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-20 (commit ee3a74e). Confidence: 100%.
...
### Code health
Three co-equal signals: code health 4.72/10 avg (Needs work), hotspot health 2.96/10 (stable), worst `crates/vim/src/state.rs` at 1.0/10 · maintainability 4.44/10 · performance risk 379 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
