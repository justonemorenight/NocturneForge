...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-19 (commit f30c226). Confidence: 100%.
...
### Code health
Three co-equal signals: code health 4.72/10 avg (Needs work), hotspot health 3.0/10 (declining), worst `crates/vim/src/state.rs` at 1.0/10 · maintainability 4.44/10 · performance risk 382 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
